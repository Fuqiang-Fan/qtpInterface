...
import com.testngScript.httpclient.HttpClientUtil;
import com.testngScript.httpclient.common.HttpConfig;
import com.testngScript.httpclient.common.HttpHeader;
import com.testngScript.httpclient.common.HttpMethods;
...
public class HttpClientApp {
    ...
    @Test
    @Parameters({"httpURL", "method", "parameterValues", "expected", "init", "script_sql", "isCrateFile", "filename","interface_select_sql", "requstContentType"})
    public void run
            (String httpURL, String method, String parameterValues,
             String expected, boolean init, String script_sql, boolean isCrateFile, String filename,String interface_select_sql, String requstContentType) throws Exception {
        try {
